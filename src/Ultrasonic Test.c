...
#pragma config(Motor,  port2,           right1,        tmotorVex393_MC29, openLoop, reversed, driveRight, encoderPort, I2C_1)
...
#pragma config(Motor,  port9,           left1,         tmotorVex393_MC29, openLoop, driveLeft, encoderPort, I2C_2)
