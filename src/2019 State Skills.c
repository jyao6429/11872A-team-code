...
autonSkills()
{
    ...
    waitUntil(getMotorEncoder(right1) > 1500);
    ...
    // Back up to square with wall and hit 3rd flag
    driveStraight(-1100, true);
    motor[right1] = -60;
    motor[left1] = -60;
    wait1Msec(750);
    ...
    // Back up to square with wall and hit wall
